...
Autonomous full-batch run on `feat/stream-robustness-and-resume` (one branch, PR #280). Done: F-011, F-002, F-001, F-003, **F-005 + F-004 + F-006** (tool-call i18n / variants / summary). Next: **F-009** (isError) → F-007 (diff + unified status) → F-008 (expand align) → F-010/012/013 (panels + store).
