...
const MESSAGES: Record<Locale, Record<string, string>> = {
  'en-US': {
    ...
    'fileExplorer.notLoaded': '{n} more items not loaded',
    'fileExplorer.maybeMore': 'There may be more items that were not loaded',
    'fileExplorer.readOnly': 'Read only',
    'fileExplorer.dismissNotice': 'Dismiss',
    'fileExplorer.errorExists': 'An item with that name already exists.',
    'fileExplorer.errorForbidden': 'You do not have permission to do that.',
    'fileExplorer.errorNotFound': 'That item no longer exists. Refresh to see the current contents.',
    'fileExplorer.errorBadRequest': 'That name is not allowed here.',
    'fileExplorer.errorGeneric': 'That action could not be completed.',
    ...
    'fileExplorer.switchToSource': 'View source',
  ...
  'ja-JP': {
    ...
    'fileExplorer.notLoaded': '他 {n} 件は未読み込み',
    'fileExplorer.maybeMore': '未読み込みの項目がまだあるかもしれません',
    'fileExplorer.readOnly': '読み取り専用',
    'fileExplorer.dismissNotice': '閉じる',
    'fileExplorer.errorExists': '同じ名前の項目がすでにあります。',
    'fileExplorer.errorForbidden': 'この操作を行う権限がありません。',
    'fileExplorer.errorNotFound': 'この項目はすでにありません。最新の状態は再読み込みしてください。',
    'fileExplorer.errorBadRequest': 'この名前はここでは使えません。',
    'fileExplorer.errorGeneric': '操作を完了できませんでした。',
    ...
    'fileExplorer.switchToSource': 'ソースを表示',
    'fileExplorer.source': 'ソース',
  ...
  'zh-TW': {
    ...
    'fileExplorer.notLoaded': '還有 {n} 個項目未載入',
    'fileExplorer.maybeMore': '可能還有項目未載入',
    'fileExplorer.readOnly': '唯讀',
    'fileExplorer.dismissNotice': '關閉',
    'fileExplorer.errorExists': '已有同名的項目。',
    'fileExplorer.errorForbidden': '你沒有執行這個動作的權限。',
    'fileExplorer.errorNotFound': '這個項目已經不存在，重新整理可看到目前的內容。',
    'fileExplorer.errorBadRequest': '這個名稱在這裡不能使用。',
    'fileExplorer.errorGeneric': '這個動作無法完成。',
    ...
    'fileExplorer.switchToSource': '檢視原始碼',
    'fileExplorer.source': '原始碼',
