      ...
      columns: [
        {
          ...
          buttons: [
            {
              label: '訂票去',
              action: { type: 'uri', uri: 'https://www.showtimes.com.tw/programs/11502' },
            },
            {
              label: '觀看預告片',
              action: { type: 'uri', uri: 'https://youtu.be/O4PlaF13SH4?si=8DQ-3fZp007s2oJA' },
            },
          ],
          defaultAction: { type: 'uri', uri: 'https://www.showtimes.com.tw/programs/11502' },
        },
        {
          title: '找死兇宅',
          text: '演員: 李星民;李熙峻;孔升妍\n導演: 南東協',
          ...
          buttons: [
            {
              label: '訂票去',
              action: { type: 'uri', uri: 'https://www.showtimes.com.tw/programs/11503' },
            },
            {
              label: '觀看預告片',
              action: { type: 'uri', uri: 'https://youtu.be/YIy0WMtjL2w?si=-MVRM40vj4r_TNN0' },
            },
          ],
          defaultAction: { type: 'uri', uri: 'https://www.showtimes.com.tw/programs/11503' },
        },
        {
          title: '鬼才之道',
          text: '演員: 陳柏霖;張榕容;王淨\n導演: 徐漢強',
          ...
          buttons: [
            {
              label: '訂票去',
              action: { type: 'uri', uri: 'https://www.showtimes.com.tw/programs/11487' },
            },
            {
              label: '觀看預告片',
              action: { type: 'uri', uri: 'https://youtu.be/a4IMYv34m_o?si=4dS1A8EuXru15nai' },
            },
          ],
          defaultAction: { type: 'uri', uri: 'https://www.showtimes.com.tw/programs/11487' },
        },
      ],
    },
  });
      ...
      chartOptions: [
        {
          spec: {
            ...
            scales: [
              { name: 'x', type: 'band', range: 'width', domain: { data: 'table', field: 'x' } },
              { name: 'y', type: 'linear', range: 'height', nice: true, zero: true, domain: { data: 'table', field: 'y1' } },
